...
- Monitoring requirements:
  ...
  * Pain medication given → pain scale before AND 10 min after- Destination determination: appropriate facility for Time Critical Diagnoses (STEMI, Stroke, Trauma, Burns, Pediatric, OB).
